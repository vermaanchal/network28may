...
//   // Calculate total repair charges
...
//   // Calculate gross amount as sum of repair and service charges
//   const grossAmount = (totalRepairCharges + totalServiceCharges).toFixed(2);
...
//             })
//             .then((responseData) => {
//               console.log(`API Data for aaNo ${aaNo}:`, responseData);
...
//         (item) => item && item.aA_Number === splitData("aaNo")[i]
//       );
//       return {
...
//         serviceCharges:
//           matchedApiData?.serviceCharges ||
//           splitData("serviceCharges")[i] ||
//           "0",
...
//       alert("Submission failed. Please check error in console for details.");
//     }
//   };
...
//                       </td>
//                       <td className="align-middle">₹{invoice.total || "0"}</td>
//                       <td className="align-middle">
//                         <span
...
//                 <div className="batch_amount_to_fix">₹ {grossAmount}</div>
//               </div>
//               <div className="text-start batch_popup_amount">
...
// export default NetworkRejectPage;
